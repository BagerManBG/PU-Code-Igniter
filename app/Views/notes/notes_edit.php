...
<div class="container">
    <div class="row justify-content-md-center">
        ...
        <div class="col-6">
            ...
            <?php endif;?>
            <form action="/notesedit/save" method="post">
                <div class="mb-3">
                    <label for="InputForTitle" class="form-label">Title</label>
                    <input type="hidden" name="id" value="<?= $note->id ?>">
                    <input type="text" name="title" class="form-control" id="InputForTitle" value="<?= $note->title ?>">
                </div>
                <div class="mb-3">
                    <label for="InputForContent" class="form-label">Content</label>
                    <textarea name="content" class="form-control" id="InputForContent" cols="30" rows="10"><?= $note->content ?></textarea>
                </div>
